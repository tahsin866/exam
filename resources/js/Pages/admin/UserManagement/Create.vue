...
const isModuleSelected = (module) => {
    const modulePermissions = module.permissions.map(p => p.name);
    return modulePermissions.length > 0 && modulePermissions.every(permission =>
        ...
        <div class="py-8 min-h-screen bg-gradient-to-br from-[#f6fafb] via-[#f2f7f2] to-[#f1f7ff] dark:from-[#101728] dark:to-[#18222e] transition-all">
            <div class=" mx-auto px-2 sm:px-6 lg:px-8">
                <Card class="shadow-2xl border-0 rounded-2xl overflow-visible backdrop-blur-xl bg-white/90 dark:bg-[#1C2536]/80">
                    <template #title>
                        <div class="flex items-center justify-between">
                            <h2 class="text-3xl font-extrabold text-gray-900 dark:text-gray-100 tracking-tight flex items-center gap-3">
                                <i class="pi pi-user-plus text-emerald-500 text-3xl" />
                    ...
                    <template #content>
                        <!-- Error Message -->
                        <div v-if="form.errors.error" class="mb-6 p-4 bg-red-100 border border-red-400 text-red-700 rounded">
                            {{ form.errors.error }}
                        </div>
                        ...
                        <form @submit.prevent="submit" autocomplete="off">
                            ...
                            <div v-if="activeTab === 'basic'" class="space-y-10">
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-7">
                                    ...
                                    <div class="space-y-2">
                                        <label for="password" class="text-sm font-semibold text-gray-700 dark:text-gray-200">পাসওয়ার্ড <span class="text-red-500">*</span></label>
                                        <Password
                                            id="password"
                                    ...
                                    <div class="space-y-2">
                                        <label for="password_confirmation" class="text-sm font-semibold text-gray-700 dark:text-gray-200">পাসওয়ার্ড নিশ্চিতকরণ <span class="text-red-500">*</span></label>
                                        <Password
                            ...
                            <div v-if="activeTab === 'permissions'" class="space-y-8">
                                ...
                                <Card class="rounded-xl shadow-none border border-emerald-100 dark:border-gray-800">
                                    ...
                                    <template #content>
                                        <div class="space-y-6">
                                            <!-- Main menu permissions: must match database permissions -->
                                                ...
                                                <div class="border rounded-lg overflow-hidden bg-white dark:bg-[#22293b] shadow-sm mb-5">
                                                    <div class="bg-gradient-to-r from-emerald-50 via-white to-emerald-100 dark:from-emerald-900/60 dark:to-[#22293b] px-4 py-3 border-b flex justify-between items-center">
                                                        <div class="flex items-center space-x-3">
                                                            ...
                                                            :indeterminate="menu.perms.some(p => form.permissions.includes(p)) && !menu.perms.every(p => form.permissions.includes(p))"
